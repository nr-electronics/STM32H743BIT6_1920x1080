...
void MX_LTDC_Init(void)
{
  ...
  pLayerCfg.WindowX1 = 1920;
  pLayerCfg.WindowY0 = 0;
  pLayerCfg.WindowY1 = 1080;
  ...
  pLayerCfg.ImageWidth = 1920;
  pLayerCfg.ImageHeight = 1080;
...
void HAL_LTDC_MspInit(LTDC_HandleTypeDef* ltdcHandle)
{
  ...
  */
    ...
    PeriphClkInitStruct.PLL3.PLL3N = 66;
...
void HAL_LTDC_MspDeInit(LTDC_HandleTypeDef* ltdcHandle)
{
  ...
  /* USER CODE END LTDC_MspDeInit 0 */
    ...
    */
    ...
    HAL_GPIO_DeInit(GPIOA, GPIO_PIN_3|GPIO_PIN_6|GPIO_PIN_8|GPIO_PIN_10);
    ...
    HAL_GPIO_DeInit(GPIOG, GPIO_PIN_6|GPIO_PIN_10);
